...
import { Pencil, ShoppingCart, Briefcase, Laptop, Gift, BadgeDollarSign, UtensilsCrossed, Car, Home, Clapperboard, HeartPulse, GraduationCap, Cat, TrendingUp } from 'lucide-react'
...
const categoryOptions = [
  ...
  { value: 'pets', label: 'Pets', icon: Cat },
